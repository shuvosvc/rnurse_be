...
const { getAllReports,getAllPrescription,getCombainedDocs,editReportStatus,editprescriptionStatus,deleteReports,deletePrescriptions ,generateTempUrl} = require("./controllers/doc");
